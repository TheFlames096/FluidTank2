...
final class TankTest {
    ...
    void fill1(GameTestHelper helper) {
        ...
        GetGameTestMethods.assertEqualHelper(FluidAmountUtil.BUCKET_WATER(), tile.getTank().content());
        GetGameTestMethods.assertEqualHelper(Items.WATER_BUCKET, player.getItemInHand(InteractionHand.MAIN_HAND).getItem());
        helper.succeed();
    }
    ...
    void fillFail1(GameTestHelper helper) {
        ...
        GetGameTestMethods.assertEqualHelper(FluidAmountUtil.BUCKET_WATER(), tile.getTank().content());
        GetGameTestMethods.assertEqualHelper(Items.LAVA_BUCKET, player.getItemInHand(InteractionHand.MAIN_HAND).getItem());
        helper.succeed();
    }
    ...
    void capacityWithCreative(GameTestHelper helper) {
        ...
        GetGameTestMethods.assertEqualHelper(GenericUnit.CREATIVE_TANK(), tile.getConnection().capacity());
        helper.succeed();
    }
    ...
    void amountWithCreative1(GameTestHelper helper) {
        ...
        GetGameTestMethods.assertEqualHelper(GenericUnit.CREATIVE_TANK(), tile.getConnection().amount());
        helper.succeed();
    }
    ...
    void fillPotionCreative1(GameTestHelper helper) {
        ...
        GetGameTestMethods.assertEqualHelper(expected, tile.getTank().content());
        GetGameTestMethods.assertEqualHelper(Items.POTION, player.getItemInHand(InteractionHand.MAIN_HAND).getItem());
        helper.succeed();
    }
    ...
    void fillPotionCreative2(GameTestHelper helper) {
        ...
        GetGameTestMethods.assertEqualHelper(content.setAmount(GenericUnit.fromFabric(54000)), tile.getTank().content());
        GetGameTestMethods.assertEqualHelper(Items.SPLASH_POTION, player.getItemInHand(InteractionHand.MAIN_HAND).getItem());
    ...
    void fillPotionCreative3(GameTestHelper helper) {
        ...
        GetGameTestMethods.assertEqualHelper(content, tile.getTank().content());
        GetGameTestMethods.assertEqualHelper(Items.SPLASH_POTION, player.getItemInHand(InteractionHand.MAIN_HAND).getItem());
        assertTrue(ItemStack.matches(potionStack, player.getItemInHand(InteractionHand.MAIN_HAND)));
        helper.succeed();
    }
    ...
    void drainPotionCreative2(GameTestHelper helper) {
        ...
        GetGameTestMethods.assertEqualHelper(content.setAmount(GenericUnit.fromFabric(59 * 27000)), tile.getConnection().getContent().get());
        GetGameTestMethods.assertEqualHelper(Items.GLASS_BOTTLE, player.getItemInHand(InteractionHand.MAIN_HAND).getItem());
        helper.succeed();
    }
    ...
    static void drainPotionFailSurvival(GameTestHelper helper, PotionType potionType, Potion potion) {
        ...
        GetGameTestMethods.assertEqualHelper(content, tile.getTank().content());
        GetGameTestMethods.assertEqualHelper(Items.BUCKET, player.getItemInHand(InteractionHand.MAIN_HAND).getItem());
        helper.succeed();
    }
    ...
    void drainMultiEffectPotion(GameTestHelper helper) {
        ...
        GetGameTestMethods.assertEqualStack(potionStack, player.getItemInHand(InteractionHand.MAIN_HAND));
        helper.succeed();
    }
}
