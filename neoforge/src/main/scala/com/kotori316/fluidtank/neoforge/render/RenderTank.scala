...
import com.kotori316.fluidtank.neoforge.render.RenderTank.getVisualTank
import com.kotori316.fluidtank.neoforge.tank.{TileCreativeTankNeoForge, TileTankNeoForge}
...
object RenderTank {
  ...
  private final def getVisualTank(tileTank: TileTank): VisualTank = {
    tileTank match {
      case forge: TileTankNeoForge => forge.visualTank
      case creativeForge: TileCreativeTankNeoForge => creativeForge.visualTank
