...
public final class FluidTank {
    ...
    public static final Map<Tier, RegistryObject<BlockTank>> TANK_MAP = Stream.of(Tier.values())
        .filter(Tier::isNormalTankTier)
        .collect(Collectors.toMap(Function.identity(), t -> BLOCK_REGISTER.register(t.getBlockName(), () -> new BlockTank(t))));
    public static final RegistryObject<BlockCreativeTank> BLOCK_CREATIVE_TANK =
        BLOCK_REGISTER.register(Tier.CREATIVE.getBlockName(), BlockCreativeTank::new);
    public static final RegistryObject<BlockVoidTank> BLOCK_VOID_TANK =
        BLOCK_REGISTER.register(Tier.VOID.getBlockName(), BlockVoidTank::new);
